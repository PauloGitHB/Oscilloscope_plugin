...
```sh
git clone https://github.com/PauloGitHB/oscilloscope_plugin.git
cd oscilloscope_plugin
...
```sh
pip install dist/oscilloscope_plugin-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Paul Levasseur | [paul.levasseur@cemes.fr](mailto:paul.levasseur@cemes.fr)
